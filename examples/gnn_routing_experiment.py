...
def prepare_training_data(
    ...
    x_data, y_data = load_iris_dataset()
    ...
    total_samples = min(n_samples, x_data.shape[0])
    ...
    for idx in range(total_samples):
        ...
        repeated_signal = sample_signal.repeat(graph_features.shape[0], 1)
        x = torch.cat([graph_features, repeated_signal], dim=1)
