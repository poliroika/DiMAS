...
class TestAgentProfileEncoding:
    ...
    def test_encode_minimal_profile(self):
        ...
        profile = AgentProfile(identifier="minimal", display_name="minimal")
    ...
    def test_encode_profiles_batch(self):
        ...
        profiles = [
            AgentProfile(identifier="a", display_name="Role A"),
            AgentProfile(identifier="b", display_name="Role B"),
        ]
...
class TestGraphIntegration:
    ...
    def test_encode_graph_agents(self):
        ...
        agents = [
            ...
            AgentProfile(
                identifier="researcher", display_name="Researcher", persona="Finds information"
            ),
            AgentProfile(identifier="writer", display_name="Writer", persona="Creates content"),
        ]
