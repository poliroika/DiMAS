        ...
        **kwargs: Any,
        ...
        for handler in self.handlers:
            try:
                ...
                self._handle_error(handler, "on_topology_changed", e)
        ...
        **kwargs: Any,
        ...
        for handler in self.handlers:
            ...
            try:
                ...
                self._handle_error(handler, "on_tool_start", e)
        ...
        **kwargs: Any,
        ...
        for handler in self.handlers:
            ...
            try:
                ...
                self._handle_error(handler, "on_tool_end", e)
        ...
        **kwargs: Any,
        ...
        for handler in self.handlers:
            ...
            try:
                ...
                self._handle_error(handler, "on_tool_error", e)
