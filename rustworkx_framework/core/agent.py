...
class AgentProfile(BaseModel):
    ...
    def get_tool_names(self) -> list[str]:
        ...
        Возвращает:
            Список имён tools (для строк - как есть, для BaseTool - tool.name).
        """
        from ..tools.base import BaseTool
    ...
    def get_tool_objects(self) -> list["BaseTool"]:
        ...
        Для строк - ищет в глобальном registry.
        Для BaseTool - возвращает как есть.
        """
        from ..tools.base import BaseTool, get_registry
