...
Пример использования (простой):
    ...
    agents = [
        AgentProfile(agent_id="solver", display_name="Solver"),
...
from rustworkx_framework.builder import build_property_graph as build_property_graph
from rustworkx_framework.callbacks import (  # noqa: F401
...
from rustworkx_framework.config import (  # noqa: F401
    FrameworkSettings,
    logger,
    setup_logging,
)
from rustworkx_framework.core import (  # noqa: F401
    AgentLLMConfig,
    AgentProfile,
    LLMConfig,
    NodeEncoder,
...
from rustworkx_framework.execution import (  # noqa: F401
    AdaptiveScheduler,
    # Dynamic topology
    EarlyStopCondition,
    ExecutionPlan,
...
try:
    from rustworkx_framework.tools import (  # noqa: F401
        BaseTool,
        FunctionTool,
        ShellTool,
        ToolCall,
...
__all__: list[str] = _BASE_EXPORTS + _TOOLS_EXPORTS
